...
class EmailQarenaAccountCreationFinal extends StatefulWidget {
  const EmailQarenaAccountCreationFinal({
    Key? key,
  }) : super(key: key);
  @override
  _EmailQarenaAccountCreationFinal createState() =>
      _EmailQarenaAccountCreationFinal();
}

class _EmailQarenaAccountCreationFinal
    extends State<EmailQarenaAccountCreationFinal> {
  _EmailQarenaAccountCreationFinal();
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Stack(children: [
                              ...
                              child: Stack(children: [
                                Positioned(
                                  ...
                                  child: SvgPicture.asset(
                                    'assets/images/group123.svg',
                                    package: 'qarena',
                                    height: 23.636474609375,
                                    width: 23.6363525390625,
                                    fit: BoxFit.none,
                                  ),
                                ),
                              ])),
                  ...
                  child: Container(
                      ...
                      child: Stack(children: [
                        ...
                        Positioned(
                          ...
                          height: 26.012,
                          child: SvgPicture.asset(
                            'assets/images/cibapple.svg',
                            package: 'qarena',
                            height: 26.01220703125,
                            width: 21.11688232421875,
                            fit: BoxFit.none,
                          ),
                        ),
                      ])),
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.856,
          ...
          child: Image.asset(
            ...
            package: 'qarena',
            height: MediaQuery.of(context).size.height * 0.052132701421800945,
            width: MediaQuery.of(context).size.width * 0.13333333333333333,
            fit: BoxFit.fill,
          ),
        ),
        Positioned(
                ...
                Positioned(
                  ...
                  child: Container(
                    height: MediaQuery.of(context).size.height *
                        0.02843601895734597,
                    width:
                        MediaQuery.of(context).size.width * 0.07179487179487179,
                    decoration: BoxDecoration(),
                  ),
                ),
                Positioned(
              ...
              child: Stack(children: [
                Positioned(
                  ...
                  child: Container(
                      ...
                      width: 226.0,
                      child: AutoSizeText(
                        'Your account is created successfully. mow login and complete your profile ',
                        style: TextStyle(
                          fontFamily: 'Helvetica Neue',
                          fontSize: 15,
              ...
              child: Stack(children: [
                Positioned(
                  ...
                  child: SvgPicture.asset(
                    ...
                    package: 'qarena',
                    height: 99.999267578125,
                    width: 99.99774169921875,
                    fit: BoxFit.none,
                  ),
                ),
              ])),
