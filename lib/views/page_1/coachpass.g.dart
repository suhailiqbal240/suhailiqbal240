...
class Coachpass extends StatefulWidget {
  const Coachpass({
    Key? key,
  }) : super(key: key);
  @override
  _Coachpass createState() => _Coachpass();
}

class _Coachpass extends State<Coachpass> {
  _Coachpass();
    ...
    return Material(
      ...
      child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: Image.asset(
                    ...
                    height: MediaQuery.of(context).size.height *
                        0.30057297837677727,
                    width:
                        MediaQuery.of(context).size.width * 0.7016319861778846,
                    fit: BoxFit.fill,
                  ),
                ),
              ])),
        ...
        Positioned(
          ...
          top: MediaQuery.of(context).size.height * 0.953,
        ...
        Positioned(
          ...
          child: SvgPicture.asset(
            'assets/images/iconlylightarrowleft.svg',
            package: 'qarena',
            height: 30.0,
            width: 30.0,
            fit: BoxFit.none,
