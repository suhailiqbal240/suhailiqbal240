...
class SignupPhonePage2 extends StatefulWidget {
  const SignupPhonePage2({
    Key? key,
  }) : super(key: key);
  @override
  _SignupPhonePage2 createState() => _SignupPhonePage2();
}

class _SignupPhonePage2 extends State<SignupPhonePage2> {
  _SignupPhonePage2();
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Stack(children: [
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.918,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.949,
        ...
        Positioned(
          ...
          child: Container(
              ...
              width: 331.0,
              child: AutoSizeText(
                'Enter the verification code we just sent on your Phone +974 0000 0000',
                style: TextStyle(
                  fontFamily: 'Helvetica Neue',
                  fontSize: 16,
